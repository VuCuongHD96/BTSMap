...
import { Station } from '../../GoogleSheet/Fetch/Station';

interface StationPopupProps {
    station: Station;
}

export function downloadExcel({ station }: StationPopupProps) {
    try {
        console.log('Starting downloadExcel with data:', station);
        ...
        const ws = XLSX.utils.aoa_to_sheet([headers, Object.values(station)]);
        ...
        alert('Có lỗi xảy ra khi tải file Excel: ' + (error as Error).message);
    }
}
